...
int frequence_sin(int frequence);
...
void main(void)
{
    ...
    printf("veuiller entrer une touche ");
    onde=menu;
    while (1)
    {
# 111 "main.c"
        switch(onde)
        {
            case menu:
                ...
                typeonde_recu = EUSART1_Read();
                printf("%c",typeonde_recu);

                if (typeonde_recu == 's')
                {
                    onde = sinus;
                }
                else if (typeonde_recu == 'c')
                {
                    onde = carre;
                }
                else if (typeonde_recu == 't')
                {
                    onde = triangulaire;
                }
                else
...
void myTimer1_ISR(void)
{
  ...
  temps_timer++;
  if (temps_timer == 6){temps_timer= 0;}
}
